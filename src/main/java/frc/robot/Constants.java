...
public final class Constants {
    // IF YOU ALTER ANYTHING, CHANGE THE COMMENT WITH IT. KEEP EVERYTHING
    // CONSISTENT!!
    // Write button numbers + function comments like so: //Button Number: What it
    // does
    ...
    public static final int automaticShooterButtonNumber = 7; // "Back" Button: Runs shooter at RPM determined by
                                                              // distance
    public static final int runShooterButtonNumber = 10; // Right Joystick Press: Runs shooter based on which mood is
                                                         // set
    ...
    public static final int kPistonForwardClimbChannel = 0; // For piston-- double solenoid, it has two channels. This
                                                            // is forward
    ...
    // Climb distances-- meant for each stage (1,2,3 respectively) (there are two
    // climbs)
    ...
    public static final double encoderClimbDistance1 = 154; // This was altered in the competition to make up for a
                                                            // build problem...
    ...
    // Shooter--
    public static final int kShooterLeftCANID = 5; // For the Shooter Motor
