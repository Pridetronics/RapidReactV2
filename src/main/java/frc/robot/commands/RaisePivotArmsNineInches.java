...
public class RaisePivotArmsNineInches extends CommandBase {
  /** Creates a new RaisePivotArmsNineInches. */
  private Climb m_climb;
  private Climb m_climbEncoder;
 
  public RaisePivotArmsNineInches(Climb climb, Climb m_ClimbEncoder) {
  ...
  public void execute() {
    ...
    if (((RelativeEncoder) m_climbEncoder).getPositionConversionFactor() >= 23){
