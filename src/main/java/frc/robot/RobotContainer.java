...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        visionModeButton.toggleWhenPressed(new VisionMode(m_shooter)); // Switches between modes. See Shooter subsytem
                                                                       // for
                                                                       // function.

        // shooterModeButton = new JoystickButton(joystickShooter,
        // Constants.shooterModeButtonNumber);
